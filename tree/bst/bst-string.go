...
/*
Package binarysearchtree creates a StringBinarySearchTree data structure for the string type

Generate a `IntBinarySearchTree` binary search tree of `int` values:
genny - in bst . go - out bst - int . go gen "String=int" ;

Generate a `StringBinarySearchTree` binary search tree of `string` values:
genny - in bst . go - out bst - string . go gen "String=string" ;
*/
...
// StringBinarySearchTree the binary search tree of Strings
...
func (bst *StringBinarySearchTree) InOrderTraverse(f func(string)) {
	bst.lock.RLock()
...
func (bst *StringBinarySearchTree) PreOrderTraverse(f func(string)) {
	bst.lock.Lock()
	defer bst.lock.Unlock()
...
func (bst *StringBinarySearchTree) PostOrderTraverse(f func(string)) {
	bst.lock.Lock()
	defer bst.lock.Unlock()
...
func (bst *StringBinarySearchTree) Search(key int) bool {
	bst.lock.RLock()
	defer bst.lock.RUnlock()
...
func (bst *StringBinarySearchTree) Remove(key int) {
	bst.lock.Lock()
	defer bst.lock.Unlock()
	remove(bst.root, key)
}
